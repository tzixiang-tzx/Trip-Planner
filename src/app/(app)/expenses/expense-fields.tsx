...
export function ExpenseFields({
  ...
  const [selected, setSelected] = useState<string[]>(
    () => values.participants ?? members.map((m) => m.id),
  );
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <input
            ...
            name="spentOn"
            type="date"
            defaultValue={values.spentOn ?? todayIso()}
            className="field mt-1.5"
          />
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div>
          ...
          <select
            id="paidById"
            name="paidById"
            defaultValue={values.paidById ?? currentUserId}
            className="field mt-1.5"
          >
            {members.map((m) => (
        ...
        <div>
          ...
          <select id="category" name="category" defaultValue={values.category ?? "food"} className="field mt-1.5">
